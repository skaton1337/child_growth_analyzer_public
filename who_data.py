...
# Read boys data
boys_file = os.path.join(os.path.dirname(__file__), 'who_data', 'hfa-boys-perc-who2007-exp.csv')
boys_df = pd.read_csv(
    boys_file, 
...
# Read girls data
girls_file = os.path.join(os.path.dirname(__file__), 'who_data', 'hfa-girls-perc-who2007-exp.csv')
